...
def mkMain(n=128, datawidth=32, numports=2):
    ...
    myram = ram.SyncRAM(m, 'myram', clk, datawidth, addrwidth, 2, with_enable=True)
    ...
    myram.connect(0, waddr, wdata, wenable, enable)
    ...
    myram.connect(1, raddr, 0, 0, enable)
    ...
    rdata = myram.rdata(1)
    rvalid = seq.Prev(Ands(renable, enable), 1)
