...
def mkLed(memory_datawidth=128):
    ...
    axi_in = vthread.AXIStreamInFifo(m, 'axi_in', clk, rst, memory_datawidth,
                                     with_last=True, noio=True)
    axi_out = vthread.AXIStreamOutFifo(m, 'axi_out', clk, rst, memory_datawidth,
                                       with_last=True, noio=True)
    ...
    def body(size, offset):
        ...
        axi_in.write_fifo(fifo_in, _size)
        ...
        axi_out.read_fifo(fifo_out, _size)
